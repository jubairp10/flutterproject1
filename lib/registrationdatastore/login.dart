...
import 'package:flutterproject1/registrationdatastore/SignUp.dart';
import 'package:flutterproject1/registrationdatastore/admin.dart';


import 'package:flutterproject1/registrationdatastore/home.dart';
import 'package:flutterproject1/registrationdatastore/splash.dart';
    ...
    if (email == 'admin@gmail.com' && password == '123456') {
      ...
      if (data.isNotEmpty) {
        Navigator.pushReplacement(context,
            MaterialPageRoute(builder: (context) => Home1(data: data,)));
        print('Login Success');
